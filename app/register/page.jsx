  ...
  return (
    <div className="pt-14 min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <h1 className="font-serif text-3xl text-noir mb-2">Register</h1>
        <p className="text-noir/60 text-sm mb-8">Create your account</p>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-noir/80 mb-1">Name</label>
            <div className="relative">
              <HiOutlineUser className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-noir/40" />
              <input
                type="text"
                value={name}
        ...
        <p className="mt-6 text-sm text-noir/60">
          ...
          <Link href="/login" className="text-noir underline hover:no-underline">
            Login
          </Link>
        </p>
      </div>
